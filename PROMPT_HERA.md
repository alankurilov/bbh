...
Composition:
Full 16:9 frame.
Bottom 25–30% of the frame: a {{BANNER_COLOR}} , fully opaque horizontal banner spanning the entire width. The banner must be 100% opaque — no transparency, no see-through areas, and no green must bleed through or show behind it.
...
Right-side portrait (image asset provided):
An image asset will be provided. Use this asset to generate and render the portrait natively inside the motion graphic — do not composite an external image file into the scene.
